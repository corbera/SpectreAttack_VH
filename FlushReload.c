...
{
  // 3. Para todos los elementos del array (de 0 a 255):
  //    - Toma el tiempo antes de acceder al elemento (utiliza __rdtscp)
  //    - Accede al elemento (junk = array[i * CHUNK_SIZE])
  //    - Toma el tiempo después de acceder al elemento (utiliza __rdtscp)
  //    - Calcula la diferencia de tiempo (tiempo después - tiempo antes)
  //    - Si la diferencia es menor que CACHE_HIT_THRESHOLD, imprime el mensaje
  //
