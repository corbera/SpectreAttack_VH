...
int main(int argc, const char **argv)
{
  ...
  // 2.- RELOAD: Accede a todos los elementos del array (junk = array[i*CHUNCK_SIZE]) y
  //     mide el tiempo de acceso. Utiliza la instrucción __rdtscp para medir el tiempo
  //     de acceso (toma el tiempo antes y después del acceso y obtiene la diferencia).
  //     Imprimer un mensaje como "Tiempo de acceso para array[i*CHUNK_SIZE]: X CPU cycles"
  //     donde X es el tiempo de acceso medido (la diferencia).
